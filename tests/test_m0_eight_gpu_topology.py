...
class M0EightGPUTopologyTests(unittest.TestCase):
    def test_frozen_topology_is_one_scheduler_disjoint_d4_and_observation_only(self) -> None:
        ...
        self.assertEqual(record["rollout"]["consumer_batch_size"], 4)
        self.assertEqual(record["rollout"]["max_concurrent_rollouts"], 8)
        self.assertEqual(record["rollout"]["max_head_offpolicyness"], 1)
